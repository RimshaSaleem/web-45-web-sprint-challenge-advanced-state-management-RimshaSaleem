...
import { addAction, set_action_Error } from "../actions";
...
const AddForm = ({ errorMessage, addAction, set_action_Error }) => {
...
export default connect(mapStateToProps, { addAction, set_action_Error })(AddForm);
//Task List:
